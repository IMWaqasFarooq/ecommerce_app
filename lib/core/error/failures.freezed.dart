...
return payment(_that);case UnknownFailure() when unknown != null:
...
return payment(_that);case UnknownFailure():
...
return payment(_that.message,_that.declineCode);case UnknownFailure() when unknown != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String message,  int? statusCode)  server,required TResult Function( String message)  network,required TResult Function( String message)  cache,required TResult Function( String message)  unauthorized,required TResult Function( String message)  validation,required TResult Function( String message,  String? declineCode)  payment,required TResult Function( String message)  unknown,}) {final _that = this;
switch (_that) {
case ServerFailure():
...
return payment(_that.message,_that.declineCode);case UnknownFailure():
...
class PaymentFailure implements Failure {
  const PaymentFailure({required this.message, this.declineCode});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PaymentFailure&&(identical(other.message, message) || other.message == message)&&(identical(other.declineCode, declineCode) || other.declineCode == declineCode));
}


@override
int get hashCode => Object.hash(runtimeType,message,declineCode);

@override
String toString() {
  return 'Failure.payment(message: $message, declineCode: $declineCode)';
}
...
@override @useResult
$Res call({
 String message, String? declineCode
});
...
/// Create a copy of Failure
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? message = null,Object? declineCode = freezed,}) {
